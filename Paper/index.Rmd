...
toc: true
abstract: "The prevailing belief is that scratch tickets are not worth playing, and this belief is often true --- but sometimes it isn't. In the Vermont Lottery specifically, we can identify times where scratch tickets are worth playing with an arbitrary level of confidence."
---
